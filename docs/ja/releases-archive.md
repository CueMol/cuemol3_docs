...
[更新履歴](releases.md)から移した、古いリリースの記録です。
直近のリリースは[更新履歴](releases.md)にあります。

!!! info "完全な記録は GitHub にあります"
    このページも更新履歴と同じく、ふだん使ううえで知っておくとよい点だけをまとめたものです。
