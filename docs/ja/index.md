...
![CueMol3 の画面例。メインウィンドウでクライオ電顕マップと ribbon モデルを表示し、レンダリングウィンドウで Umbreon によるレイトレーシングを実行しているところ](assets/images/index/app-example.webp){ .on-glb }
...
| リンク | 内容 |
|---|---|
| [更新履歴](releases.md) | リリースごとの主な変更点 |
| [GitHub Releases](https://github.com/CueMol/cuemol2/releases) | 配布物のダウンロードと詳細なリリースノート (→ [ダウンロード](install/index.md#ダウンロード)) |
