...
| 操作 | ショートカット |
|---|---|
| Tool palette (ツールパレットの折りたたみ) | ++cmd+shift+p++ |

→ [View メニュー](../menu/view.md#ツールパレット)

## その他

| 操作 | キー |
|---|---|
| シーンツリー・Camera パネルで選択した行を削除 | ++delete++ / ++backspace++ |
| 名前の変更を始める (シーンツリー・Camera パネル・Paint の表) | ++f2++ |
