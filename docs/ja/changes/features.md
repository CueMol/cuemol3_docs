...
| Renderer 種類ごとのプロパティダイアログ | **プロパティインスペクタ** | ダイアログを廃し、常設パネルでのライブ編集になりました → [プロパティインスペクタ](../ui/inspector.md) |
...
| Object 削除のダイアログ | **シーンツリーの Delete** | 選択式で削除対象を指定する専用ダイアログは廃止されました |
