...
| OS | 配布物 (例: バージョン 2.3.15.530) | インストーラー形式 |
|---|---|---|
| macOS (Apple Silicon / arm64) | `CueMol3-2.3.15.530-macOS-arm64-Installer.dmg` | ディスクイメージ |
| Windows (x64) | `CueMol3-2.3.15.530-Windows-x64-Setup.exe` | NSIS ウィザード型インストーラー |
| Linux (x64) | `CueMol3-2.3.15.530-Linux-x64.AppImage` / `CueMol3-2.3.15.530-Linux-x64.deb` | AppImage / Debian パッケージ |
