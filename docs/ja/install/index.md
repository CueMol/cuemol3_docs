...
| OS | 配布物 (例: バージョン 2.3.11.507) | インストーラー形式 |
|---|---|---|
| macOS (Apple Silicon / arm64) | `CueMol3-2.3.11.507-macOS-arm64-Installer.dmg` | ディスクイメージ |
| Windows (x64) | `CueMol3-2.3.11.507-Windows-x64-Setup.exe` | NSIS ウィザード型インストーラー |
| Linux (x64) | `CueMol3-2.3.11.507-Linux-x64.AppImage` / `CueMol3-2.3.11.507-Linux-x64.deb` | AppImage / Debian パッケージ |
